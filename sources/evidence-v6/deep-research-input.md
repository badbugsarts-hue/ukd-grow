...
gantt
    ...
    title Grow-Plan Inhaltsprüfung – Meilensteine
    section Vorbereitung
    Inventarisierung der Inhalte      :a1, 2026-08-09, 7d
    Fachliteratur-Recherche          :a2, after a1, 14d
    section Analyse & Korrektur
    Identifikation von Lücken/Risiken :a3, after a2, 10d
    Erarbeitung Korrekturmaßnahmen   :a4, after a3, 14d
    section Abschluss
    Erstellung Fakten- und Quellenblättern  :a5, after a4, 7d
    Review, Dokumentation & Abschluss        :a6, after a5, 8d
```
