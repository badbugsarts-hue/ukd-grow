...
4. Functional authenticity & zero shortcuts:
   - Confirm that all 61 cultivars in `autoflower-cockpit.json` are authentic.
...
5. Write your final audit report to `c:\Users\badbu\Documents\grow\.agents\auditor_2\report.md` and create `handoff.md` with your definitive verdict: **CLEAN** or **INTEGRITY VIOLATION**.
