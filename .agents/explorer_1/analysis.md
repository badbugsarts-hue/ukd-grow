...
- **30-Second Rule**: In under 30 seconds, an operator looking at any view must know:
  1. *Wo bin ich?* (Where am I in the run timeline / phase?)
  2. *Was muss ich prüfen?* (What mandatory measurements/checks are open today?)
  3. *Was darf ich tun?* (What action is authorized?)
  4. *Was ist gesperrt oder nur bedingt?* (What is blocked or conditional, and why?)
  5. *Was muss ich danach dokumentieren?* (What needs to be logged?)
...
- *Invariant Rule*: Switching lenses changes **only explanation depth and density**, NEVER calculations, safety gates, or underlying numbers.
...
*Report prepared by Explorer 1. Ready for handoff to Parent & Implementer agents.*
