...
describe("Milestone 5 Quality Gate & E2E Verification Suite", () => {
	...
	describe("2. Sensor Calibration Trust & Expiry Engine", () => {
		it("derives valid, expired, and uncalibrated statuses accurately for pH and EC sensors", () => {
			...
			// Uncalibrated case
			const uncalibratedPh = getSensorCalibrationStatus("ph-1", "water.ph", [], now);
			...
			const validPh = getSensorCalibrationStatus("ph-1", "water.ph", [validPhRecord], now);
			...
			const expiredPh = getSensorCalibrationStatus("ph-1", "water.ph", [expiredPhRecord], now);
			...
			const failedEc = getSensorCalibrationStatus("ec-1", "water.ec", [failedEcRecord], now);
				...
				auditEvents: [
					{
						...
						entityType: "ppfd-map",
						entityId: "ppfd-map-1",
						detail: "9-Punkt PPFD Mapping erfasst: Mean 520 µmol, Uniformität 84.5% bei 40 cm.",
					},
