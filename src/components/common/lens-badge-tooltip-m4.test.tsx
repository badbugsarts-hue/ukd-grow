...
describe("Milestone 4 - LensBadge Click Cycling & State Harness", () => {
  it("cycles lens state correctly in sequence: guided -> advanced -> expert -> guided", () => {
    ...
    let badge = {
      props: {
        "aria-label": "Erfahrungsstufe: GEFÜHRT",
        className: "lens-badge-guided",
      },
    } as any;
    ...
    badge = {
      props: {
        "aria-label": "Erfahrungsstufe: STANDARD",
        className: "lens-badge-advanced",
      },
    } as any;
    ...
    badge = {
      props: {
        "aria-label": "Erfahrungsstufe: EXPERTE",
        className: "lens-badge-expert",
      },
    } as any;
