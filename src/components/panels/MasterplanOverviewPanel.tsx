...
export function MasterplanOverviewPanel({
  ...
  const lightIdentity = run.config.light
    ? [run.config.light.manufacturer, run.config.light.model]
        .filter(Boolean)
        .join(" ")
    : "Hersteller/Modell nicht erfasst";
  const medium =
    run.config.mediumProduct || run.config.medium || "Nicht erfasst";
  ...
  return (
    <div className="panel-container">
      ...
      <div className="panel-header">
        ...
        <p>
          Evidenzgeschützte Orientierung auf Basis des aktiven Runs und des
          kanonischen Tagesplans
        </p>
      </div>
          ...
          >
            ...
            >
              <div>
                ...
                <div style={{ color: "var(--muted)" }}>
                  Alles logisch geordnet.
                </div>
              </div>
              <div>
                <strong>Schritt-für-Schritt</strong>
                <div style={{ color: "var(--muted)" }}>
                  Du weißt immer, was als Nächstes ansteht.
                </div>
              </div>
              <div>
                <strong>Verständliche Begriffe</strong>
                <div style={{ color: "var(--muted)" }}>
                  Erklärungen immer dort, wo du sie brauchst.
                </div>
              </div>
              <div>
                <strong>Sichere Entscheidungen</strong>
                <div style={{ color: "var(--muted)" }}>
                  Entscheidungs-Hilfe & Warnungen.
                </div>
              </div>
              <div style={{ gridColumn: "1 / -1" }}>
                <strong>Alles verknüpft</strong>
                <div style={{ color: "var(--muted)" }}>
                  Pläne, Messungen, Aktionen in einem System.
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      {run.config.tentWidthCm} × {run.config.tentDepthCm} ×{" "}
                      {run.config.tentHeightCm} cm
                    </button>
                  </li>
                  <li
                    style={{
                  ...
                  >
                    ...
                    >
                      {run.config.ledMaxW} W max. · {lightIdentity}
                    </button>
                  </li>
                  <li
                    style={{
                  ...
                  >
                    ...
                    >
                      {run.config.irrigationSystem || "Nicht erfasst"}
                    </button>
                  </li>
                  <li
                    style={{
                  ...
                  >
                    ...
                    >
                      {run.config.pot.nominalVolumeLiters} L · Typ{" "}
                      {run.config.pot.type}
                    </button>
                  </li>
                  <li
                  ...
                  >
                    <strong>Genetik (v12):</strong>
                    <button
                      type="button"
                      onClick={() => navigate("autoflower")}
                      style={{
                        minHeight: "44px",
                        padding: "6px 12px",
                        display: "inline-flex",
              ...
              <div>
                ...
                >
                  <li>
                    <strong>Phase:</strong> {textAt(plan, DAILY_COLUMNS.phase)}
                  </li>
                  <li>
                    <strong>Temperatur Licht:</strong>{" "}
                    {numberAt(plan, DAILY_COLUMNS.tempLight)} °C
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>pH / EC:</strong>{" "}
                    {numberAt(plan, DAILY_COLUMNS.ph).toFixed(1)} /{" "}
                    {numberAt(plan, DAILY_COLUMNS.ec).toFixed(2)} mS/cm
                  </li>
                  <li>
                    <strong>Photoperiode:</strong>{" "}
                    {numberAt(plan, DAILY_COLUMNS.lightHours)} h
                  </li>
                </ul>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <div style={{ color: "var(--muted)", marginBottom: "2px" }}>
                  Zeigt, wie viele Nährstoffe im Wasser sind.
                </div>
              ...
              <div>
                ...
                <div style={{ color: "var(--muted)", marginBottom: "2px" }}>
                  Zeigt, wie sauer oder basisch das Wasser ist.
                </div>
                <div style={{ fontSize: "11px", color: "var(--purple)" }}>
                  Zielwerte kommen aus dem kanonischen Tagesplan.
                </div>
              </div>
              <div>
                <strong>VPD (Luft-Druckdefizit)</strong>
                <div style={{ color: "var(--muted)", marginBottom: "2px" }}>
                  Zeigt, wie viel Feuchtigkeit die Luft aufnehmen kann.
                </div>
                <div style={{ fontSize: "11px", color: "var(--purple)" }}>
                  Ziel ist phasen- und datenabhängig.
                </div>
              </div>
              <div>
                <strong>DLI (Tageslichtmenge)</strong>
                <div style={{ color: "var(--muted)", marginBottom: "2px" }}>
                  Gesamtmenge an Licht pro Tag.
                </div>
                <div style={{ fontSize: "11px", color: "var(--purple)" }}>
                  Einheit: mol/m²/Tag
                </div>
              ...
              <div>
                ...
                <div style={{ color: "var(--muted)", marginBottom: "2px" }}>
                  Wie viel Licht auf deine Pflanzen trifft.
                </div>
                <div style={{ fontSize: "11px", color: "var(--purple)" }}>
                  Einheit: µmol/m²/s
                </div>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ color: "var(--muted)", fontSize: "12px" }}>
                    Endgültiger Topf (pH 5.5 - 6.5) + LST
                  </div>
                </div>
              </div>
            </div>
